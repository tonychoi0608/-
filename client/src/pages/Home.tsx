            ...
            <div className="space-y-4">
              <AnimatePresence mode="popLayout">
                {feedbacks.map((feedback, index) => (
                  ...
                  >
                    <Card className="rounded-2xl border-none shadow-[var(--shadow-subtle)] hover:shadow-[var(--shadow-float)] transition-shadow duration-300 bg-white">
                      <CardContent className="p-5 sm:p-6">
                        <div className="flex items-start gap-4 sm:gap-5">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-foreground/90 leading-relaxed whitespace-pre-wrap text-sm sm:text-base bg-secondary/20 p-4 rounded-xl mt-3">
                              {feedback.content}
                            </div>
                          </div>
